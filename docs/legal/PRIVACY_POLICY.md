...
We share information with trusted vendors who assist us:
...
These vendors are contractually obligated to use your data only for providing services to us.
...
You can request deletion of your data, except where we have legal obligations to retain it.
...
### Right to Object
You can object to our processing of your data for marketing or analytics.
...
### Right to Know
You can request what personal information is collected and how it is used.

### Right to Delete
You can request deletion of personal information (with exceptions for legal obligations).

### Right to Opt-Out
You can opt out of "sale" or "sharing" of your information (we do not sell data, but we may share for analytics).
...
**Analytics Cookies:**
- Google Analytics (understand usage patterns)
...
**Opting out does not prevent the Service from functioning but may limit personalization.**
